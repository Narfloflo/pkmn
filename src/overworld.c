...
static const u8 sMapsecToRegion[] = {
    ...
    [MAPSEC_SEVEN_ISLAND]               = REGION_HOENN,
    [MAPSEC_SIX_ISLAND]                 = REGION_SEVII,
    [MAPSEC_KINDLE_ROAD]                = REGION_HOENN,
    [MAPSEC_TREASURE_BEACH]             = REGION_HOENN,
    [MAPSEC_CAPE_BRINK]                 = REGION_HOENN,
    ...
    [MAPSEC_RESORT_GORGEOUS]            = REGION_HOENN,
    [MAPSEC_WATER_LABYRINTH]            = REGION_SEVII,
    [MAPSEC_FIVE_ISLE_MEADOW]           = REGION_HOENN,
    [MAPSEC_MEMORIAL_PILLAR]            = REGION_SEVII,
    [MAPSEC_OUTCAST_ISLAND]             = REGION_HOENN,
    [MAPSEC_GREEN_PATH]                 = REGION_HOENN,
    [MAPSEC_WATER_PATH]                 = REGION_HOENN,
    [MAPSEC_RUIN_VALLEY]                = REGION_HOENN,
    [MAPSEC_TRAINER_TOWER]              = REGION_SEVII,
    [MAPSEC_CANYON_ENTRANCE]            = REGION_HOENN,
    [MAPSEC_SEVAULT_CANYON]             = REGION_HOENN,
    ...
    [MAPSEC_MT_EMBER]                   = REGION_HOENN,
    [MAPSEC_BERRY_FOREST]               = REGION_HOENN,
    [MAPSEC_ICEFALL_CAVE]               = REGION_HOENN,
    [MAPSEC_ROCKET_WAREHOUSE]           = REGION_HOENN,
    [MAPSEC_TRAINER_TOWER_2]            = REGION_SEVII,
    [MAPSEC_DOTTED_HOLE]                = REGION_HOENN,
    ...
    [MAPSEC_LIPTOO_CHAMBER]             = REGION_KANTO,
