...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_ROSE_1, TRAINER_ROSE_5, TRAINER_ROSE_5, TRAINER_ROSE_5, TRAINER_ROSE_5, ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, TRAINER_ANDRES_2, TRAINER_ANDRES_3, TRAINER_ANDRES_4, TRAINER_ANDRES_5, ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_DUSTY_1, TRAINER_DUSTY_5, TRAINER_DUSTY_5, TRAINER_DUSTY_5, TRAINER_DUSTY_5, ROUTE111),
    [REMATCH_LOLA] = REMATCH(TRAINER_LOLA_1, TRAINER_LOLA_5, TRAINER_LOLA_5, TRAINER_LOLA_5, TRAINER_LOLA_5, ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_RICKY_1, TRAINER_RICKY_5, TRAINER_RICKY_5, TRAINER_RICKY_5, TRAINER_RICKY_5, ROUTE109),
    [REMATCH_LILA_AND_ROY] = REMATCH(TRAINER_LILA_AND_ROY_1, TRAINER_LILA_AND_ROY_5, TRAINER_LILA_AND_ROY_5, TRAINER_LILA_AND_ROY_5, TRAINER_LILA_AND_ROY_5, ROUTE124),
    [REMATCH_CRISTIN] = REMATCH(TRAINER_CRISTIN_1, TRAINER_CRISTIN_5, TRAINER_CRISTIN_5, TRAINER_CRISTIN_5, TRAINER_CRISTIN_5, ROUTE121),
    [REMATCH_BROOKE] = REMATCH(TRAINER_BROOKE_1, TRAINER_BROOKE_5, TRAINER_BROOKE_5, TRAINER_BROOKE_5, TRAINER_BROOKE_5, ROUTE111),
    [REMATCH_WILTON] = REMATCH(TRAINER_WILTON_1, TRAINER_WILTON_5, TRAINER_WILTON_5, TRAINER_WILTON_5, TRAINER_WILTON_5, ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_VALERIE_1, TRAINER_VALERIE_5, TRAINER_VALERIE_5, TRAINER_VALERIE_5, TRAINER_VALERIE_5, MT_PYRE_6F),
    [REMATCH_CINDY] = REMATCH(TRAINER_CINDY_1, TRAINER_CINDY_6, TRAINER_CINDY_6, TRAINER_CINDY_6, TRAINER_CINDY_6, ROUTE104),
    [REMATCH_THALIA] = REMATCH(TRAINER_THALIA_1, TRAINER_THALIA_5, TRAINER_THALIA_5, TRAINER_THALIA_5, TRAINER_THALIA_5, ABANDONED_SHIP_ROOMS_1F),
    [REMATCH_JESSICA] = REMATCH(TRAINER_JESSICA_1, TRAINER_JESSICA_5, TRAINER_JESSICA_5, TRAINER_JESSICA_5, TRAINER_JESSICA_5, ROUTE121),
    [REMATCH_WINSTON] = REMATCH(TRAINER_WINSTON_1, TRAINER_WINSTON_5, TRAINER_WINSTON_5, TRAINER_WINSTON_5, TRAINER_WINSTON_5, ROUTE104),
    [REMATCH_STEVE] = REMATCH(TRAINER_STEVE_1, TRAINER_STEVE_5, TRAINER_STEVE_5, TRAINER_STEVE_5, TRAINER_STEVE_5, ROUTE114),
    [REMATCH_TONY] = REMATCH(TRAINER_TONY_1, TRAINER_TONY_5, TRAINER_TONY_5, TRAINER_TONY_5, TRAINER_TONY_5, ROUTE107),
    [REMATCH_NOB] = REMATCH(TRAINER_NOB_1, TRAINER_NOB_5, TRAINER_NOB_5, TRAINER_NOB_5, TRAINER_NOB_5, ROUTE115),
    [REMATCH_KOJI] = REMATCH(TRAINER_KOJI_1, TRAINER_KOJI_5, TRAINER_KOJI_5, TRAINER_KOJI_5, TRAINER_KOJI_5, ROUTE127),
    [REMATCH_FERNANDO] = REMATCH(TRAINER_FERNANDO_1, TRAINER_FERNANDO_5, TRAINER_FERNANDO_5, TRAINER_FERNANDO_5, TRAINER_FERNANDO_5, ROUTE123),
    [REMATCH_DALTON] = REMATCH(TRAINER_DALTON_1, TRAINER_DALTON_5, TRAINER_DALTON_5, TRAINER_DALTON_5, TRAINER_DALTON_5, ROUTE118),
    [REMATCH_BERNIE] = REMATCH(TRAINER_BERNIE_1, TRAINER_BERNIE_5, TRAINER_BERNIE_5, TRAINER_BERNIE_5, TRAINER_BERNIE_5, ROUTE114),
    [REMATCH_ETHAN] = REMATCH(TRAINER_ETHAN_1, TRAINER_ETHAN_5, TRAINER_ETHAN_5, TRAINER_ETHAN_5, TRAINER_ETHAN_5, JAGGED_PASS),
    [REMATCH_JOHN_AND_JAY] = REMATCH(TRAINER_JOHN_AND_JAY_1, TRAINER_JOHN_AND_JAY_5, TRAINER_JOHN_AND_JAY_5, TRAINER_JOHN_AND_JAY_5, TRAINER_JOHN_AND_JAY_5, METEOR_FALLS_1F_2R),
    [REMATCH_JEFFREY] = REMATCH(TRAINER_JEFFREY_1, TRAINER_JEFFREY_5, TRAINER_JEFFREY_5, TRAINER_JEFFREY_5, TRAINER_JEFFREY_5, ROUTE120),
    [REMATCH_CAMERON] = REMATCH(TRAINER_CAMERON_1, TRAINER_CAMERON_5, TRAINER_CAMERON_5, TRAINER_CAMERON_5, TRAINER_CAMERON_5, ROUTE123),
    [REMATCH_JACKI] = REMATCH(TRAINER_JACKI_1, TRAINER_JACKI_5, TRAINER_JACKI_5, TRAINER_JACKI_5, TRAINER_JACKI_5, ROUTE123),
    [REMATCH_WALTER] = REMATCH(TRAINER_WALTER_1, TRAINER_WALTER_5, TRAINER_WALTER_5, TRAINER_WALTER_5, TRAINER_WALTER_5, ROUTE121),
    [REMATCH_KAREN] = REMATCH(TRAINER_KAREN_1, TRAINER_KAREN_5, TRAINER_KAREN_5, TRAINER_KAREN_5, TRAINER_KAREN_5, ROUTE116),
    [REMATCH_JERRY] = REMATCH(TRAINER_JERRY_1, TRAINER_JERRY_5, TRAINER_JERRY_5, TRAINER_JERRY_5, TRAINER_JERRY_5, ROUTE116),
    [REMATCH_ANNA_AND_MEG] = REMATCH(TRAINER_ANNA_AND_MEG_1, TRAINER_ANNA_AND_MEG_5, TRAINER_ANNA_AND_MEG_5, TRAINER_ANNA_AND_MEG_5, TRAINER_ANNA_AND_MEG_5, ROUTE117),
    [REMATCH_ISABEL] = REMATCH(TRAINER_ISABEL_1, TRAINER_ISABEL_5, TRAINER_ISABEL_5, TRAINER_ISABEL_5, TRAINER_ISABEL_5, ROUTE110),
    [REMATCH_MIGUEL] = REMATCH(TRAINER_MIGUEL_1, TRAINER_MIGUEL_5, TRAINER_MIGUEL_5, TRAINER_MIGUEL_5, TRAINER_MIGUEL_5, ROUTE103),
    [REMATCH_TIMOTHY] = REMATCH(TRAINER_TIMOTHY_1, TRAINER_TIMOTHY_5, TRAINER_TIMOTHY_5, TRAINER_TIMOTHY_5, TRAINER_TIMOTHY_5, ROUTE115),
    [REMATCH_SHELBY] = REMATCH(TRAINER_SHELBY_1, TRAINER_SHELBY_5, TRAINER_SHELBY_5, TRAINER_SHELBY_5, TRAINER_SHELBY_5, MT_CHIMNEY),
    [REMATCH_CALVIN] = REMATCH(TRAINER_CALVIN_1, TRAINER_CALVIN_5, TRAINER_CALVIN_5, TRAINER_CALVIN_5, TRAINER_CALVIN_5, ROUTE102),
    [REMATCH_ELLIOT] = REMATCH(TRAINER_ELLIOT_1, TRAINER_ELLIOT_5, TRAINER_ELLIOT_5, TRAINER_ELLIOT_5, TRAINER_ELLIOT_5, ROUTE106),
    [REMATCH_ISAIAH] = REMATCH(TRAINER_ISAIAH_1, TRAINER_ISAIAH_5, TRAINER_ISAIAH_5, TRAINER_ISAIAH_5, TRAINER_ISAIAH_5, ROUTE128),
    [REMATCH_MARIA] = REMATCH(TRAINER_MARIA_1, TRAINER_MARIA_5, TRAINER_MARIA_5, TRAINER_MARIA_5, TRAINER_MARIA_5, ROUTE117),
    [REMATCH_ABIGAIL] = REMATCH(TRAINER_ABIGAIL_1, TRAINER_ABIGAIL_5, TRAINER_ABIGAIL_5, TRAINER_ABIGAIL_5, TRAINER_ABIGAIL_5, ROUTE110),
    [REMATCH_DYLAN] = REMATCH(TRAINER_DYLAN_1, TRAINER_DYLAN_5, TRAINER_DYLAN_5, TRAINER_DYLAN_5, TRAINER_DYLAN_5, ROUTE117),
    [REMATCH_KATELYN] = REMATCH(TRAINER_KATELYN_1, TRAINER_KATELYN_5, TRAINER_KATELYN_1, TRAINER_KATELYN_5, TRAINER_KATELYN_5, ROUTE128),
    [REMATCH_BENJAMIN] = REMATCH(TRAINER_BENJAMIN_1, TRAINER_BENJAMIN_5, TRAINER_BENJAMIN_5, TRAINER_BENJAMIN_5, TRAINER_BENJAMIN_5, ROUTE110),
    [REMATCH_PABLO] = REMATCH(TRAINER_PABLO_1, TRAINER_PABLO_5, TRAINER_PABLO_5, TRAINER_PABLO_5, TRAINER_PABLO_5, ROUTE126),
    [REMATCH_NICOLAS] = REMATCH(TRAINER_NICOLAS_1, TRAINER_NICOLAS_5, TRAINER_NICOLAS_5, TRAINER_NICOLAS_5, TRAINER_NICOLAS_5, METEOR_FALLS_1F_2R),
    [REMATCH_ROBERT] = REMATCH(TRAINER_ROBERT_1, TRAINER_ROBERT_5, TRAINER_ROBERT_5, TRAINER_ROBERT_5, TRAINER_ROBERT_5, ROUTE120),
    [REMATCH_LAO] = REMATCH(TRAINER_LAO_1, TRAINER_LAO_5, TRAINER_LAO_5, TRAINER_LAO_5, TRAINER_LAO_5, ROUTE113),
    [REMATCH_CYNDY] = REMATCH(TRAINER_CYNDY_1, TRAINER_CYNDY_5, TRAINER_CYNDY_5, TRAINER_CYNDY_5, TRAINER_CYNDY_5, ROUTE115),
    [REMATCH_MADELINE] = REMATCH(TRAINER_MADELINE_1, TRAINER_MADELINE_5, TRAINER_MADELINE_5, TRAINER_MADELINE_5, TRAINER_MADELINE_5, ROUTE113),
    [REMATCH_JENNY] = REMATCH(TRAINER_JENNY_1, TRAINER_JENNY_5, TRAINER_JENNY_5, TRAINER_JENNY_5, TRAINER_JENNY_5, ROUTE124),
    [REMATCH_DIANA] = REMATCH(TRAINER_DIANA_1, TRAINER_DIANA_5, TRAINER_DIANA_5, TRAINER_DIANA_5, TRAINER_DIANA_5, JAGGED_PASS),
    [REMATCH_AMY_AND_LIV] = REMATCH(TRAINER_AMY_AND_LIV_1, TRAINER_AMY_AND_LIV_6, TRAINER_AMY_AND_LIV_6, TRAINER_AMY_AND_LIV_6, TRAINER_AMY_AND_LIV_6, ROUTE103),
    [REMATCH_ERNEST] = REMATCH(TRAINER_ERNEST_1, TRAINER_ERNEST_5, TRAINER_ERNEST_5, TRAINER_ERNEST_5, TRAINER_ERNEST_5, ROUTE125),
    [REMATCH_CORY] = REMATCH(TRAINER_CORY_1, TRAINER_CORY_5, TRAINER_CORY_5, TRAINER_CORY_5, TRAINER_CORY_5, ROUTE108),
    [REMATCH_EDWIN] = REMATCH(TRAINER_EDWIN_1, TRAINER_EDWIN_5, TRAINER_EDWIN_5, TRAINER_EDWIN_5, TRAINER_EDWIN_5, ROUTE110),
    [REMATCH_LYDIA] = REMATCH(TRAINER_LYDIA_1, TRAINER_LYDIA_5, TRAINER_LYDIA_5, TRAINER_LYDIA_5, TRAINER_LYDIA_5, ROUTE117),
    [REMATCH_ISAAC] = REMATCH(TRAINER_ISAAC_1, TRAINER_ISAAC_5, TRAINER_ISAAC_5, TRAINER_ISAAC_5, TRAINER_ISAAC_5, ROUTE117),
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_GABRIELLE_1, TRAINER_GABRIELLE_5, TRAINER_GABRIELLE_5, TRAINER_GABRIELLE_5, TRAINER_GABRIELLE_5, MT_PYRE_3F),
    [REMATCH_CATHERINE] = REMATCH(TRAINER_CATHERINE_1, TRAINER_CATHERINE_5, TRAINER_CATHERINE_5, TRAINER_CATHERINE_5, TRAINER_CATHERINE_5, ROUTE119),
    [REMATCH_JACKSON] = REMATCH(TRAINER_JACKSON_1, TRAINER_JACKSON_5, TRAINER_JACKSON_5, TRAINER_JACKSON_5, TRAINER_JACKSON_5, ROUTE119),
    [REMATCH_HALEY] = REMATCH(TRAINER_HALEY_1, TRAINER_HALEY_5, TRAINER_HALEY_5, TRAINER_HALEY_5, TRAINER_HALEY_5, ROUTE104),
    [REMATCH_JAMES] = REMATCH(TRAINER_JAMES_1, TRAINER_JAMES_5, TRAINER_JAMES_5, TRAINER_JAMES_5, TRAINER_JAMES_5, PETALBURG_WOODS),
    [REMATCH_TRENT] = REMATCH(TRAINER_TRENT_1, TRAINER_TRENT_5, TRAINER_TRENT_5, TRAINER_TRENT_5, TRAINER_TRENT_5, ROUTE112),
    [REMATCH_SAWYER] = REMATCH(TRAINER_SAWYER_1, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, TRAINER_SAWYER_5, MT_CHIMNEY),
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE_1, TRAINER_ROXANNE_5, TRAINER_ROXANNE_5, TRAINER_ROXANNE_5, TRAINER_ROXANNE_5, RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_BRAWLY_1, TRAINER_BRAWLY_5, TRAINER_BRAWLY_5, TRAINER_BRAWLY_5, TRAINER_BRAWLY_5, DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_WATTSON_1, TRAINER_WATTSON_5, TRAINER_WATTSON_5, TRAINER_WATTSON_5, TRAINER_WATTSON_5, MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_FLANNERY_1, TRAINER_FLANNERY_5, TRAINER_FLANNERY_5, TRAINER_FLANNERY_5, TRAINER_FLANNERY_5, LAVARIDGE_TOWN),
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_1, TRAINER_NORMAN_5, TRAINER_NORMAN_5, TRAINER_NORMAN_5, TRAINER_NORMAN_5, PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(TRAINER_WINONA_1, TRAINER_WINONA_5, TRAINER_WINONA_5, TRAINER_WINONA_5, TRAINER_WINONA_5, FORTREE_CITY),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TATE_AND_LIZA_1, TRAINER_TATE_AND_LIZA_5, TRAINER_TATE_AND_LIZA_5, TRAINER_TATE_AND_LIZA_5, TRAINER_TATE_AND_LIZA_5, MOSSDEEP_CITY),
...
void BattleSetup_StartLegendaryBattle(void)
{
    ...
    case SPECIES_RAIKOU:
        ...
        break;
      case SPECIES_CELEBI:
        CreateBattleStartTask(B_TRANSITION_GRID_SQUARES, MUS_GSC_WILD);
        break;    
    }
...
void PlayTrainerEncounterMusic(void)
{
        ...
        && sTrainerBattleMode != TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE_NO_MUSIC)
    {
        ...
        case TRAINER_ENCOUNTER_MUSIC_RICH:
            ...
            break;
        case TRAINER_ENCOUNTER_MUSIC_BOY_KANTO:
            music = MUS_RG_ENCOUNTER_BOY;
            break;
        case TRAINER_ENCOUNTER_MUSIC_LASS_KANTO:
...
static u16 GetRematchTrainerIdFromTable(const struct RematchTrainer *table, u16 firstBattleTrainerId)
{
    ...
    s32 i;
    s32 tableId;
    u16 lastTrainerId; // Déclaration en haut de fonction (C90)

    tableId = FirstBattleTrainerIdToRematchTableId(table, firstBattleTrainerId);
    ...
    // MODIFICATION : Permet le rematch infini du dernier dresseur
    lastTrainerId = trainerEntry->trainerIds[REMATCHES_COUNT - 1];
    
    // Si on a atteint le compteur de pas maximum, on permet un nouveau rematch
    // du dernier dresseur en resetant son flag
    if (IsRematchStepCounterMaxed())
    {
        // Reset le flag "battu" pour permettre un nouveau combat
        FlagClear(TRAINER_FLAGS_START + lastTrainerId);
        
        // Reset le compteur de pas pour recommencer le cycle
        gSaveBlock1Ptr->trainerRematchStepCounter = 0;
        
        // Maintenant le dresseur peut être recombattu
        return lastTrainerId;
    }
    
    // Si le compteur n'est pas au max, on retourne l'ID mais le combat ne sera pas possible
    return lastTrainerId;
}
