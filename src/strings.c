...
const u8 gText_AbraPrizeAndPrice[] = _("ABRA 100 COINS");
const u8 gText_CubonePrizeAndPrice[] = _("CUBONE 800 COINS");
const u8 gText_WobbuffetPrizeAndPrice[] = _("WOBBUFFET 1,500 COINS");
