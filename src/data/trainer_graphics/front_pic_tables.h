const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_WALLACE] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_MISTY] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_LTSURGE] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_POLICE] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_KIMONO] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_LASSKANTO] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_CAMPERKANTO] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_PICNICKERKANTO] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_BROCK] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_YOUNGSTERKANTO] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_THUG] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_BIKER] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_ERIKA] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_COOLTRAINERKANTOM] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_COOLTRAINERKANTOF] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_GAMBLER] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_WHITNEY] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_SABRINA] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_KOGA] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_BLUE] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_BUGSY] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_BLAINE] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_MORTY] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_CHUCK] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_JASMINE] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_CLAIR] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_PROF_OAK] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_BEAUTY_KANTO] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_BIRDKEEPER_KANTO] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_FALKNER] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_ROCKET] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_PRYCE] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_SAGE] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_FIREBREATHER] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_POKEMANIAC_JOHTO] = {.size = 8, .y_offset = 2},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(WALLACE, gTrainerFrontPic_MayorWallace, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(MISTY, gTrainerFrontPic_Misty, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LTSURGE, gTrainerFrontPic_LtSurge, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(POLICE, gTrainerFrontPic_Police, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(KIMONO, gTrainerFrontPic_Kimono, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LASSKANTO, gTrainerFrontPic_LassKanto, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CAMPERKANTO, gTrainerFrontPic_CamperKanto, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(PICNICKERKANTO, gTrainerFrontPic_PicnickerKanto, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BROCK, gTrainerFrontPic_Brock, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(YOUNGSTERKANTO, gTrainerFrontPic_YoungsterKanto, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(THUG, gTrainerFrontPic_Thug, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BIKER, gTrainerFrontPic_Biker, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ERIKA, gTrainerFrontPic_Erika, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(COOLTRAINERKANTOM, gTrainerFrontPic_CooltrainerKanto_M, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(COOLTRAINERKANTOF, gTrainerFrontPic_CooltrainerKanto_F, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GAMBLER, gTrainerFrontPic_Gambler, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(WHITNEY, gTrainerFrontPic_Whitney, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(BUGSY, gTrainerFrontPic_Bugsy, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BLAINE, gTrainerFrontPic_Blaine, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(MORTY, gTrainerFrontPic_Morty, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CHUCK, gTrainerFrontPic_Chuck, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(JASMINE, gTrainerFrontPic_Jasmine, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CLAIR, gTrainerFrontPic_Clair, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(PROF_OAK, gTrainerFrontPic_ProfOak, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BEAUTY_KANTO, gTrainerFrontPic_BeautyKanto, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BIRDKEEPER_KANTO, gTrainerFrontPic_BirdKeeperKanto, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(FALKNER, gTrainerFrontPic_Falkner, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ROCKET, gTrainerFrontPic_Rocket, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(PRYCE, gTrainerFrontPic_Pryce, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(POKEMANIAC_JOHTO, gTrainerFrontPic_PokemaniacJohto, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(WALLACE, gTrainerPalette_MayorWallace),
    TRAINER_PAL(MISTY, gTrainerPalette_Misty),
    TRAINER_PAL(LTSURGE, gTrainerPalette_LtSurge),
    TRAINER_PAL(POLICE, gTrainerPalette_Police),
    TRAINER_PAL(KIMONO, gTrainerPalette_Kimono),
    TRAINER_PAL(LASSKANTO, gTrainerPalette_LassKanto),
    TRAINER_PAL(CAMPERKANTO, gTrainerPalette_CamperKanto),
    TRAINER_PAL(PICNICKERKANTO, gTrainerPalette_PicnickerKanto),
    TRAINER_PAL(BROCK, gTrainerPalette_Brock),
    TRAINER_PAL(YOUNGSTERKANTO, gTrainerPalette_YoungsterKanto),
    TRAINER_PAL(THUG, gTrainerPalette_Thug),
    TRAINER_PAL(BIKER, gTrainerPalette_Biker),
    TRAINER_PAL(ERIKA, gTrainerPalette_Erika),
    TRAINER_PAL(COOLTRAINERKANTOM, gTrainerPalette_CooltrainerKanto_M),
    TRAINER_PAL(COOLTRAINERKANTOF, gTrainerPalette_CooltrainerKanto_F),
    ...
    TRAINER_PAL(PROF_OAK, gTrainerPalette_ProfOak),
    TRAINER_PAL(BEAUTY_KANTO, gTrainerPalette_BeautyKanto),
    TRAINER_PAL(BIRDKEEPER_KANTO, gTrainerPalette_BirdKeeperKanto),
    TRAINER_PAL(FALKNER, gTrainerPalette_Falkner),
    TRAINER_PAL(ROCKET, gTrainerPalette_Rocket),
    ...
    TRAINER_PAL(POKEMANIAC_JOHTO, gTrainerPalette_PokemaniacJohto),
};
