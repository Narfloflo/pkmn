const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            ...
                            {EVO_ITEM, ITEM_063, SPECIES_POLITOED}},
    ...
    [SPECIES_MACHOKE]    = {{EVO_TRADE, 0, SPECIES_MACHAMP},
                            {EVO_ITEM, ITEM_063, SPECIES_MACHAMP}},
    ...
    [SPECIES_HAUNTER]    = {{EVO_TRADE, 0, SPECIES_GENGAR},
                            {EVO_ITEM, ITEM_063, SPECIES_GENGAR}},

    [SPECIES_ONIX]       = {{EVO_ITEM, ITEM_063, SPECIES_STEELIX},
    ...
    [SPECIES_SEADRA]     = {{EVO_ITEM, ITEM_063, SPECIES_KINGDRA},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_TRADE_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
                            ...
                            {EVO_ITEM, ITEM_063, SPECIES_HUNTAIL},
                            {EVO_ITEM, ITEM_064, SPECIES_GOREBYSS}},
