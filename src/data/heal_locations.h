static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_RUSTBORO_CITY - 1] = {MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY), 53, 35},
    ...
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 23, 15},
    ...
    [HEAL_LOCATION_MOSSDEEP_ - 1] = {MAP_GROUP(MOSSDEEP_), MAP_NUM(MOSSDEEP_), 27, 30},
    [HEAL_LOCATION_SECRET_CITY - 1] = {MAP_GROUP(SECRET_CITY), MAP_NUM(SECRET_CITY), 22, 12},
};
